# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-12-01 14:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_nbr_3', models.CharField(blank=True, max_length=30)),
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('additional_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='additional_address', to='invoice.Address')),
                ('main_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='main_address', to='invoice.Address')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='material',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='invoice.Material_Group'),
        ),
        migrations.AddField(
            model_name='material',
            name='manufacturer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='invoice.Manufacturer'),
        ),
        migrations.AddField(
            model_name='material',
            name='tax',
